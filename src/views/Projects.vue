    ...
    data() {
        return {
            ...
            projects: [
            {
                    "id": 1,
                    "title": "Englist",
                    "content": "This is a Flutter app that Users can use it to collect words they want to remember into their notes anytime, anywhere.",
                    "imageUrl": "https://github.com/LeeMoofon0222/Picture-Repository/blob/main/Pictures/Englist.png?raw=true",
                    "class": "App Flutter Dart "
                },
                {
                    "id": 2,
                    "title": "VR-Baseball",
                    "content": "This is a VR Game created with Unity. Users can use it to play baseball in a virtual world.",
                ...
                },
                {
                    "id": 3,
                    "title": "Logic.AI",
                    "content": "This is a NO CODE tool that allows users to easily apply logical reasoning to identify patterns in data.",
                    "imageUrl": "https://github.com/LeeMoofon0222/Logic.AI/raw/main/ReadMe_Picture/Pic1.png?raw=true",
                    "class": "AI YOLO python"
                },
                {
                    "id": 4,
                    "title": "Auto-login-NTUT-i-study",
                    "content": "The purpose of this project is to expedite access to the NTUT iStudy platform and save more time.",
                    "imageUrl": "https://github.com/LeeMoofon0222/Auto-login-NTUT-i-study/blob/main/ReadMe_Picture/Pic10.png?raw=true",
                    "class": "AI selenium python open-cv"
                },
                {
                    "id": 5,
                    "title": "DIS",
                    "content": "The game is built with the Unity3D engine, using the Universal Render Pipeline for rendering. It adopts a Low Poly visual style",
                ...
                },
                {
                    ...
                    "content": "This project is a game developed using pygame. In this game, player can control a spaceship that can move and also shoot missiles.",
                    "imageUrl": "https://github.com/LeeMoofon0222/Picture-Repository/blob/main/Pictures/Escaped%20from%20space.png?raw=true",
                    "class": "Game Python Pygame"
                },
                {
                    "id": 7,
                    "title": "Auto parking",
                    "content": "Utilizing the built-in package ML-Agents in Unity, we employ reinforcement learning techniques to enable a virtual car to achieve automated parking functionality.",
                ...
                },
                {
                    "id": 8,
                    "title": "My-Blog",
                    "content": "This is a Blog which is the website you're waching. It record my projects and other thing. Created with Vuetify+Asp.net Core",
                    "imageUrl": "https://github.com/LeeMoofon0222/Picture-Repository/blob/main/Pictures/Blog.png?raw=true",
                    "class": "Website Vuetify Asp.net Core"
                },
            ],
        }
    },
    computed: {
        ...
        searching() {
            ...
            return this.projects.filter(project => {
                const text = project.title.toLowerCase() + project.content.toLowerCase() + project.class.toLowerCase();
